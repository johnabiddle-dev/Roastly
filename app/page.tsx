    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20">
        ...
        <div className="space-y-3 sm:space-y-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-6">
            <p className="text-red-400 text-xs sm:text-sm mb-1">BRUTAL</p>
            <p className="text-base sm:text-lg">“You look like you were generated by AI and the prompt was ‘make it worse’.”</p>
          </div>

          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-6">
            <p className="text-red-400 text-xs sm:text-sm mb-1">SAVAGE</p>
            <p className="text-base sm:text-lg">“Your entire personality is just ‘I saw this on TikTok’.”</p>
          </div>

          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-6">
            <p className="text-red-400 text-xs sm:text-sm mb-1">UNHINGED</p>
            <p className="text-base sm:text-lg">“You give off ‘I peaked in middle school and I’ve been chasing that high ever since’ energy.”</p>
          </div>

          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-6">
            <p className="text-red-400 text-xs sm:text-sm mb-1">SAVAGE</p>
            <p className="text-base sm:text-lg">“Even your shadow wants to distance itself from you.”</p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tighter">Pay only for what you use</h2>
          <p className="text-base sm:text-xl text-zinc-400 mt-3 sm:mt-4">One-time packs or the daily Pro option. All purchases unlock 10 roasts/day (capped).</p>
        </div>
        ...
        <p className="text-center text-[10px] sm:text-xs text-zinc-500 mt-6 sm:mt-8">
          Starter/Popular/Heavy are one-time payments. Unlimited Roasts is a recurring monthly subscription. All unlock 10 roasts/day (capped).
          <br className="hidden sm:block" />Add "Create Your Own Prompt" for $1.99 one-time on any paid tier.
        </p>
      </div>
